...
G0.2a adds executable residual, weaker-model, and closure contracts for the
assessment semantics, while preserving `NoVerdictYet`: no `BirthGate`,
`BirthVerdict`, `BirthCandidate`, `Freeze`, or E0 authority exists yet.
