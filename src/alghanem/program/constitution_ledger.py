...
class DeclaredLawStatus(Enum):
    ...
    ENFORCED_AT_CERTIFICATION_GATE = "ENFORCED_AT_CERTIFICATION_GATE"
    ENFORCED_AT_EXECUTION_GATE = "ENFORCED_AT_EXECUTION_GATE"
    ENFORCED_AT_COVERAGE_GATE = "ENFORCED_AT_COVERAGE_GATE"
    ENFORCED_AT_CASE_DATA_GATE = "ENFORCED_AT_CASE_DATA_GATE"
    ...
    ENFORCED_AT_MANTUQ_MAFHUM_IFADA = "ENFORCED_AT_MANTUQ_MAFHUM_IFADA"
    ENFORCED_AT_EXPERIMENTAL_AUTHORITY = "ENFORCED_AT_EXPERIMENTAL_AUTHORITY"
    ENFORCED_AT_EXPERIMENTAL_RUN_BINDING = "ENFORCED_AT_EXPERIMENTAL_RUN_BINDING"
    ENFORCED_AT_EXPERIMENTAL_CONTENT_ENCODER = (
        "ENFORCED_AT_EXPERIMENTAL_CONTENT_ENCODER"
    )
    ENFORCED_AT_EXPERIMENTAL_EVIDENCE_GATE = "ENFORCED_AT_EXPERIMENTAL_EVIDENCE_GATE"
    ENFORCED_AT_LINGUISTIC_NUCLEUS = "ENFORCED_AT_LINGUISTIC_NUCLEUS"
    ENFORCED_AT_EXISTENCE_AXIS = "ENFORCED_AT_EXISTENCE_AXIS"
    ENFORCED_AT_ANCHORED_NUCLEUS = "ENFORCED_AT_ANCHORED_NUCLEUS"
    ENFORCED_AT_ORIGIN_CHAIN = "ENFORCED_AT_ORIGIN_CHAIN"
