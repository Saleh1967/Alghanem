...
* ولا تُعلِن هذه الوحدة سمةً بديلة ولا تجربةً ثانية: اختيار سمات جديدة
  **بعد** رؤية العناقيد هو ما تمنعه بوّابة ما قبل الدليل في `kernel/`، فأي
  تجربة تالية تحتاج مواصفةً مُجمَّدة قبل دليلها. وهذا الشرط صار مفروضًا بنيويًّا
  لا مذكورًا نثرًا في `probe_preregistration.py`: هناك لا تُبنى نتيجةٌ أصلًا إلا
  مربوطةً بمواصفةٍ سبقتها تجميدًا ومحتوًى. وأرقام هذا التقرير وقيمه لا تتغيّر
  بذلك: هي سجلّ تجربة ماضية، لا مواصفة تجربة قادمة.
