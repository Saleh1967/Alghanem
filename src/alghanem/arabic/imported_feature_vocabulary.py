...
SOURCE_DIGEST_REDERIVATION_NOTE: Final = (
    "مخطَّط بصمة المصدر (gflk.canonical.v1) صار مُودَعًا في "
    "imported_vocabulary_source_digest بدقّة البايت، فإعادة اشتقاقها من حمولةٍ "
    "مصدرية حسابٌ مستقلّ لا مقارنةٌ بمرجعٍ مُصرَّح به؛ والحمولة الكاملة نفسها "
    "ليست في هذا المستودع بعد، فما دامت غائبةً يبقى المُثبَّت هنا رقمًا "
    "مُعلَنًا تُطابَق به حمولةٌ حين تُودَع، لا شهادةَ تحقّقٍ جرى فعلًا"
)
