...
**وقد صُحِّح العيبان بعدُ، إلى الأمام لا بالرجوع**: انظر
`ud_objecthood_amendment` — مواصفةٌ ثانيةٌ ببصمةٍ أخرى ومنزلةٍ أضعفَ مُصرَّحٍ بها
(`معدَّلة_بعد_الرقم`)، تستثني الأقسامَ الوظيفية وتفتح منزلةً رابعةً للموضع
المقروء غيرِ المتنبَّأ به. ولم يُمَسَّ حرفٌ من هذه الوحدة ولا من مواصفتها، فرقمُ
الدعوى كما نُطِق بها باقٍ عند ٣٥٫٨٪ حيث قِيس.
