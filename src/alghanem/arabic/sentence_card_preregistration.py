    ...
    registrations=(
        ...
        _registration(
            ...
            note=(
                ...
                "**نتيجةَ مسحٍ جرى** لا لغياب بحث. ثم نُقِل نصُّ مادة (ن و ر) "
                "من «مقاييس اللغة» مُعاضِدًا في `sentence_card_source_texts`، "
                "وفيه ردُّ المادة إلى أصلٍ يدلّ على الإضاءة والاضطراب؛ وذلك "
                "اشتقاقٌ تسمويٌّ معجميٌّ لا يحسم جمودَ «نور» ولا اشتقاقَه "
                "صرفيًّا، فالبندُ يبقى `ينتظر_نصًّا_مصدريًّا` في مرجعه المُعلَن. "
                "ويُسجَّل هنا فارقٌ يُخشى طيُّه: «المشتق» في قسمة الكلّي غيرُ "
                "«المشتق» الصرفيّ المقصود في هذا البند"
            ),
            refusals=(
                NamedRefusal(
                ...
                NamedRefusal(
                    name="EtymologicalDerivationIsNotMorphologicalStatus",
                    statement=(
                        "ETYMOLOGICAL_DERIVATION_IS_NOT_MORPHOLOGICAL_JUMUD_"
                        "MUSHTAQ_STATUS: «سُمِّيا بذلك من طريقة الإضاءة» بيانُ "
                        "وجهِ التسمية وردُّ فروع المادة إلى مقياسٍ دلاليٍّ "
                        "جامع، وسؤالُ البند بناءُ لفظٍ بعينه: أجامدٌ اسمُ عينٍ "
                        "هو أم مشتقّ؟ فالجنسان مختلفان، وحملُ أحدهما على الآخر "
                        "قراءةُ جوابٍ من غير سؤاله"
                    ),
                ),
                NamedRefusal(
        ...
        _registration(
            ...
            note=(
                ...
                "كلمة البطاقة، والفارقُ يُسجَّل ولا يُطوى. ونصُّ «مقاييس اللغة» "
                "المُعاضِد («والمنارة: مفعلة من الاستنارة، والأصل منورة») "
                "يشهد للوزن نفسِه بأصله المُعَلّ، **وهو شاهدٌ للمشتقّ نفسِه لا "
                "لكلمة البطاقة**؛ فيُقوّي الرصدَ ولا يُسقط هذه البقيّة، ولا "
                "يُبدِّل مرجعَ البند المُعلَن"
            ),
            refusals=(
                NamedRefusal(
        ...
        _registration(
            ...
            note=(
                ...
                "ونصُّ «مقاييس اللغة» المُعاضِد يردّ فروعَ المادة إلى أصلٍ واحدٍ "
                "مُسمًّى (الإضاءة والاضطراب وقلّة الثبات)، وهو مقياسٌ دلاليٌّ "
                "للمادة لا دالّةُ اشتقاقٍ مُرمَّزة، ولا يُبدِّل مرجعَ البند "
                "المُعلَن ولا يُغيِّر موقفَه"
            ),
            refusals=(
                NamedRefusal(
