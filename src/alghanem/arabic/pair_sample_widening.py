...
**أوّلًا: بأيّ شيءٍ وُسِّعت؟** لا ثالثَ للمُودَعَين حين قِيس هذا السُّلَّم؛
فُتِّشت الشجرةُ فلم يُوجَد نصٌّ قرآنيٌّ مشكولٌ ثالث، وبايتاتُ المدوّنة كانت
يومَها غائبة. ثمّ أُودِعت بعدَ هذا القياس مُطابِقةً بصمتَها، وهي **نطاقٌ
رابعٌ لم يُقَس ههنا**: أرقامُ هذا السُّلَّم مجمَّدةٌ على درجاته الثلاث، ولا
يُضَمّ إليها رقمٌ من المدوّنة إلّا بقياسٍ يُعلَن كما أُعلِنت
(`THE_CORPUS_FIGURE_IS_PUBLISHED_ONLY_FROM_THE_FINGERPRINTED_BYTES`). والباقي في
