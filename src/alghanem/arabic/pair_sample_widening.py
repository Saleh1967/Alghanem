...
| + نثر الشجرة | 17,418 | 9/36 | فتحة+شدّة (7,612) | سكون+خنجريّة (1) |

فالتوسيعُ **544 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 17,406 من 17,418 — أي **99.931%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 979 و9 عاملُ 108. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,594** من 17,386 في
النثر — أي 26.424%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
THE_THIRD_RUNG_AT_MEASUREMENT: Final[RungFigures] = RungFigures(
    total_pairs=17418,
    realized=9,
    shadda_bearing=17406,
    tanwin_initial_in_prose=4594,
    prose_pairs=17386,
)
