...
| + نثر الشجرة | 17,290 | 9/36 | فتحة+شدّة (7,571) | سكون+خنجريّة (1) |

فالتوسيعُ **540 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 17,278 من 17,290 — أي **99.931%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 972 و9 عاملُ 108. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,546** من 17,258 في
النثر — أي 26.341%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
THE_THIRD_RUNG_AT_MEASUREMENT: Final[RungFigures] = RungFigures(
    total_pairs=17290,
    realized=9,
    shadda_bearing=17278,
    tanwin_initial_in_prose=4546,
    prose_pairs=17258,
)
