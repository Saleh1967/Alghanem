...
| + نثر الشجرة | 16,712 | 9/36 | فتحة+شدّة (7,343) | سكون+خنجريّة (1) |

فالتوسيعُ **522 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 16,700 من 16,712 — أي **99.928%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 936 و9 عاملُ 104. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,411** من 16,680 في
النثر — أي 26.445%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
WIDENING_INTO_A_NEW_REGISTER_CHANGES_THE_POPULATION_NOT_ONLY_ITS_SIZE: Final[str] = (
    ...
    "و4,411 من 16,680 في النثر. فليست الكبرى عيّنةً أكبرَ من الشيء نفسه، "
