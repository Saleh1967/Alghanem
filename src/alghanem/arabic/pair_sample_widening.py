...
| + نثر الشجرة | 16,574 | 9/36 | فتحة+شدّة (7,293) | سكون+خنجريّة (1) |

فالتوسيعُ **517 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 16,562 من 16,574 — أي **99.928%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 924 و9 عاملُ 102. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,379** من 16,542 في
النثر — أي 26.472%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
WIDENING_INTO_A_NEW_REGISTER_CHANGES_THE_POPULATION_NOT_ONLY_ITS_SIZE: Final[str] = (
    ...
    "و4,379 من 16,542 في النثر. فليست الكبرى عيّنةً أكبرَ من الشيء نفسه، "
