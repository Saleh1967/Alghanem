...
| + نثر الشجرة | 16,517 | 9/36 | فتحة+شدّة (7,275) | سكون+خنجريّة (1) |

فالتوسيعُ **516 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 16,505 من 16,517 — أي **99.927%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 917 و9 عاملُ 102. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,361** من 16,485 في
النثر — أي 26.454%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
WIDENING_INTO_A_NEW_REGISTER_CHANGES_THE_POPULATION_NOT_ONLY_ITS_SIZE: Final[str] = (
    ...
    "و4,361 من 16,485 في النثر. فليست الكبرى عيّنةً أكبرَ من الشيء نفسه، "
