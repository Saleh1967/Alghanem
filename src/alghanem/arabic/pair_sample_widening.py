...
| + نثر الشجرة | 17,374 | 9/36 | فتحة+شدّة (7,604) | سكون+خنجريّة (1) |

فالتوسيعُ **543 ضعفًا** في عدد المزدوجات. وفيه جوابُ السؤالين معًا:
...
منها `X + شدّة` وتحوز 17,362 من 17,374 — أي **99.931%** — وثلاثةٌ تحوز **12**
وقوعًا لا غير. وبين 977 و9 عاملُ 108. فليس بين الجسم والقاع تدرّجٌ يُقرأ منه
ترتيبٌ في الندرة.
...
بتنوينٍ: **صفرٌ** من 32 في المُودَعَين القرآنيَّين، و**4,572** من 17,342 في
النثر — أي 26.364%. فالنثرُ يُظهِر تركيباتِ تنوينٍ لم يُظهِرها النصّان ألبتّة.
...
THE_THIRD_RUNG_AT_MEASUREMENT: Final[RungFigures] = RungFigures(
    total_pairs=17374,
    realized=9,
    shadda_bearing=17362,
    tanwin_initial_in_prose=4572,
    prose_pairs=17342,
)
